...
int	zbx_default_uint32_compare_func(const void *d1, const void *d2)
{
	const zbx_uint32_t	*i1 = (const zbx_uint32_t *)d1;
	const zbx_uint32_t	*i2 = (const zbx_uint32_t *)d2;
...
int	zbx_default_uint16_compare_func(const void *d1, const void *d2)
{
	const zbx_uint16_t	*i1 = (const zbx_uint16_t *)d1;
	const zbx_uint16_t	*i2 = (const zbx_uint16_t *)d2;
